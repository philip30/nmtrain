...
def post_process(prediction_output, trg_vocab, unk_lexicon, src_batch, src_vocab):
  source_sent = src_batch.data[0].src_sent.content() + [src_vocab.eos()]
  ...
  src_batch.data[0].src_sent.annotate("bpe_merge", merge_src)
  # Unknown Replacement
